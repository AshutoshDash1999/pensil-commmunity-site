...
function CommunityCard({communityName, communityBanner, communityUsers}) {
  return (
...
<div className="w-full max-w-sm bg-gray-50 rounded-lg hover:bg-gray-100 shadow-md hover:shadow-xl transition ease-in-out duration-150">
    ...
    <div className="px-5 pb-5">
        <a href="#">
            <h5 className="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">{communityName}</h5>
        </a>
        ...
        <div className="flex justify-between items-center">
            <span className="text-xl font-bold text-gray-900 dark:text-white">{communityUsers} Active Users</span>
            <Button>Join</Button>
