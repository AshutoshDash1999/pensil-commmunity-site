      ...
      <div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
        <ul className="space-y-2">
          ...
          <li>
            <a
              href="#"
              className="flex items-center p-2 text-base font-normal text-gray-500 hover:text-gray-900 hover:font-bold rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">GamePoint</span>
            </a>
          </li>
          <li>
            <a
        ...
        >
          ...
          <p className="mb-3 text-sm text-blue-900">
            Enjoy all the latest features, join unlimited groups and chat with
            anyone with our Pro subscription.
          </p>
          <a
