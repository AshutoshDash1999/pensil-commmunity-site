      ...
      <div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ml-3 whitespace-nowrap">Explore Groups</span>
        ...
        >
          ...
          <p className="mb-3 text-sm text-blue-900">
            Enjoy all the latest features, join unlimited groups and chat with anyone with our Pro subscription.
          </p>
          <a
